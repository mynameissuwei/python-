...
start_date = '2020-10-01'  # 回测起始时间
end_date = '2021-01-26'  # 回测结束时间
...
def ranking(df,condition1='doublelow',condition2='remainSize'):
    '''
    组装排名
    '''
    'remainSize'
...
def handle_data(context):    
    ...
    filter_data = ranking(data.copy(),condition1='doublelow')
    print(filter_data,'filter_datafilter_data')
