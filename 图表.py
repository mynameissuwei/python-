...
filename = '持仓市值_bondPremRatio.xlsx'
df = pd.read_excel(filename)

filename2 = '持仓市值_doublelow.xlsx'
df2 = pd.read_excel(filename2)

filename2 = '持仓市值_closePriceBond.xlsx'
df3 = pd.read_excel(filename2)
